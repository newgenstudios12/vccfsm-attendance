...
.vccf-daily-verse{position:relative;overflow:hidden;margin:0 0 14px;padding:clamp(13px,2vw,17px);border:1px solid color-mix(in srgb,var(--brand) 18%,var(--line));background:linear-gradient(135deg,color-mix(in srgb,var(--brand) 7%,var(--card)),color-mix(in srgb,var(--brand2) 8%,var(--card)));box-shadow:var(--shadow);isolation:isolate}
.vccf-daily-verse:after{content:'“';position:absolute;right:14px;top:-20px;font-family:Georgia,serif;font-size:6rem;line-height:1;color:color-mix(in srgb,var(--brand) 10%,transparent);z-index:-1;pointer-events:none}
.vccf-daily-verse-head{display:flex;align-items:center;justify-content:space-between;gap:10px;margin-bottom:8px}.vccf-daily-verse-kicker{display:flex;align-items:center;gap:7px;font-size:.66rem;font-weight:900;letter-spacing:.08em;text-transform:uppercase;color:var(--brand)}
.vccf-daily-verse-icon{width:24px;height:24px;border-radius:8px;display:grid;place-items:center;background:color-mix(in srgb,var(--brand) 11%,var(--card));font-size:.82rem}.vccf-daily-verse-date{font-size:.64rem;color:var(--muted);font-weight:700}
.vccf-daily-verse-text{margin:0;max-width:980px;font-family:'Plus Jakarta Sans',Manrope,system-ui,sans-serif;font-size:clamp(.92rem,1.5vw,1.06rem);font-weight:700;line-height:1.45;color:var(--text)}
.vccf-daily-verse-reference{display:flex;align-items:center;gap:6px;flex-wrap:wrap;margin-top:7px;font-size:.72rem}.vccf-daily-verse-reference strong{font-size:.78rem;color:var(--text)} .vccf-daily-verse-translation{padding:3px 6px;border-radius:999px;border:1px solid var(--line);color:var(--muted);font-size:.6rem;font-weight:900}.vccf-daily-verse-publisher{font-size:.62rem;color:var(--muted)}
.vccf-daily-verse-rights{margin-top:5px;font-size:.58rem;line-height:1.35;color:var(--muted)}
.vccf-daily-verse-foot{display:flex;align-items:center;justify-content:space-between;gap:8px;flex-wrap:wrap;margin-top:10px;padding-top:8px;border-top:1px solid color-mix(in srgb,var(--line) 75%,transparent)}.vccf-daily-verse-note{display:flex;align-items:center;gap:6px;color:var(--muted);font-size:.62rem;line-height:1.35}.vccf-daily-verse-actions{display:flex;gap:8px;flex-wrap:wrap}.vccf-daily-verse-copy,.vccf-daily-verse-manage{min-height:30px;padding:6px 9px;font-size:.64rem}.vccf-daily-verse-status{font-size:.72rem;color:var(--muted)}
...
@media(max-width:600px){.vccf-daily-verse{border-radius:16px;padding:13px}.vccf-daily-verse-head{align-items:flex-start}.vccf-daily-verse-date{text-align:right}.vccf-daily-verse-foot{align-items:flex-start}.vccf-daily-verse-actions{display:flex;width:100%}.vccf-daily-verse-copy,.vccf-daily-verse-manage{width:auto;flex:1}.vccf-verse-modal{padding:8px}.vccf-verse-dialog{max-height:94vh;border-radius:18px}.vccf-verse-dialog-head,.vccf-verse-dialog-body{padding:16px}.vccf-verse-form-grid{grid-template-columns:1fr}.vccf-verse-field.full,.vccf-verse-rights,.vccf-verse-switch,.vccf-verse-form-actions,.vccf-verse-save-status{grid-column:1}.vccf-verse-form-actions{display:grid}.vccf-verse-form-actions .btn{width:100%}}
...
function ensureCard(){
  ...
  if(!card){card=document.createElement('section');card.id='vccfDailyVerseCard';card.className='card vccf-daily-verse';card.setAttribute('aria-live','polite');const service=dashboard.querySelector('.dashboard-latest-service'),banner=dashboard.querySelector('.welcome-banner'),after=service||banner;if(after)after.insertAdjacentElement('afterend',card);else{const anchor=dashboard.querySelector('.stats')||dashboard.firstElementChild;dashboard.insertBefore(card,anchor||null);}}
  return card;
}
